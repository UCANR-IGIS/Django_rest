...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_DB', 'clearinghouse_test'),
        'USER': os.environ.get('DATABASE_USER', 'postgres'),
        'PASSWORD': os.environ.get('DATABASE_PASSWORD', 'ANR_GIS_Admin'),
...
MIDDLEWARE = (
    ...
    'clearinghouse.middleware.TenantTutorialMiddleware',
...
ROOT_URLCONF = 'clearinghouse.urls_tenants'
PUBLIC_SCHEMA_URLCONF = 'clearinghouse.urls_public'
...
TENANT_USERS_DOMAIN = "trendy-sass.com"
...
SESSION_COOKIE_DOMAIN = ".trendy-sass.com"
...
MULTITENANT_RELATIVE_MEDIA_ROOT = "media"
DEFAULT_AUTO_FIELD = 'django.db.models.AutoField'

MULTITENANT_STATICFILES_DIRS = [
    os.path.join( "C:/Users/stfei/PycharmProjects/clearinghouse_beta/clearinghouse", "tenants/%s/static" ),
]
